...
def generate_scope_pairs():
    ...
    pairs += every_template.generate(lf_template_1)
    pairs += every_template.generate(lf_template_2)
    ...
    pairs += each_template.generate(lf_template_1)
    pairs += each_template.generate(lf_template_2)
...
def generate_unambiguous():
    ...
    pairs += indef_indef_transitive_template.generate(indef_indef_lf_template)
    ...
    pairs += indef_def_transitive_template.generate(indef_def_lf_template)
    ...
    pairs += def_indef_transitive_template.generate(def_indef_lf_template)
    ...
    pairs += def_def_transitive_template.generate(def_def_lf_template)
    ...
    pairs += def_intransitive_template.generate(def_intransitive_lf_template)
    ...
    pairs += conj_def_intransitive_template.generate(conj_def_intransitive_lf_template)
    ...
    pairs += disj_def_intransitive_template.generate(disj_def_intransitive_lf_template)
