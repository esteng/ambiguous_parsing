...
def generate_with_pp_pairs(vp_list = VISUAL_VPS,
    ...
    pairs += indef_indef_template.generate(indef_indef_lf_template_1, 0)
    pairs += indef_indef_template.generate(indef_indef_lf_template_2, 1)
    ...
    pairs += indef_def_template.generate(indef_def_lf_template_1, 0)
    pairs += indef_def_template.generate(indef_def_lf_template_2, 1)
    ...
    pairs += def_indef_template.generate(def_indef_lf_template_1, 0)
    pairs += def_indef_template.generate(def_indef_lf_template_2, 1)
    ...
    pairs += def_def_template.generate(def_def_lf_template_1, 0)
    pairs += def_def_template.generate(def_def_lf_template_2, 1)
...
def generate_conjunction_pairs():
    ...
    pairs += and_first_template.generate(and_first_lf_template_1, 0)
    pairs += and_first_template.generate(and_first_lf_template_2, 1)
    ...
    pairs += or_first_template.generate(or_first_lf_template_1, 0)
    pairs += or_first_template.generate(or_first_lf_template_2, 1)
...
def generate_scope_pairs():
    ...
    pairs += every_template.generate(lf_template_1, 0)
    pairs += every_template.generate(lf_template_2, 1)
    ...
    pairs += each_template.generate(lf_template_1, 0)
    pairs += each_template.generate(lf_template_2, 1)
...
def generate_unambiguous():
    ...
    pairs += indef_indef_transitive_template.generate(indef_indef_lf_template, 0)
    ...
    pairs += indef_def_transitive_template.generate(indef_def_lf_template, 0)
    ...
    pairs += def_indef_transitive_template.generate(def_indef_lf_template, 0)
    ...
    pairs += def_def_transitive_template.generate(def_def_lf_template, 0)
    ...
    pairs += indef_intransitive_template.generate(indef_intransitive_lf_template, 0)
    ...
    pairs += def_intransitive_template.generate(def_intransitive_lf_template, 0)
    ...
    pairs += conj_indef_intransitive_template.generate(conj_indef_intransitive_lf_template, 0)
    ...
    pairs += conj_def_intransitive_template.generate(conj_def_intransitive_lf_template, 0)
    ...
    pairs += disj_indef_intransitive_template.generate(disj_indef_intransitive_lf_template, 0)
    ...
    pairs += disj_def_intransitive_template.generate(disj_def_intransitive_lf_template, 0)
